...
import { 
  User, Sparkles, ArrowRight, Mail, Lock, Phone, Briefcase, 
  CheckCircle2, Globe, Rocket, Target, DollarSign, Calendar, 
...
const CandidateSignup = () => {
  ...
  const [preferredWorkType, setPreferredWorkType] = useState<string[]>(['remote', 'hybrid']);
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-8 max-w-lg">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full">
              ...
              <span className="text-white/80 text-[10px] font-bold tracking-[0.1em] uppercase">Talent Ecosystem</span>
            </div>
            
            <h1 className="text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] tracking-tight">
              Launch Your <br />
              <span className="bg-gradient-to-r from-primary via-emerald-400 to-green-400 bg-clip-text text-transparent">Contract Career</span>
            </h1>
            
            <p className="text-xl text-white/50 leading-relaxed font-light">
              Join the elite network of professional contractors and get discovered by industry leaders worldwide.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-2xl">
            ...
            />
                  ...
                  <h3 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-2">
                    {currentStep === 1 ? 'Create Account' : currentStep === 2 ? 'Professional Profile' : 'Career Preferences'}
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  {currentStep === 1 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      ...
                      <div className="grid md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-2">
                          <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Confirm</Label>
                          <div className="relative group">
                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-primary transition-all duration-300" />
                            <Input
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      <div className="grid md:grid-cols-2 gap-5">
                        <div className="space-y-2">
                          <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Candidate Type</Label>
                          <Select 
                            value={formData.candidateType} 
                            onValueChange={(val) => setFormData({...formData, candidateType: val})}
                          >
                          <SelectTrigger className="h-12 bg-slate-50/50 dark:bg-white/[0.02] border-slate-200 dark:border-white/[0.08] rounded-xl focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all duration-300 text-sm font-medium">
                            ...
                            <SelectContent className="bg-white dark:bg-[#0a0a0a] border-slate-200 dark:border-white/[0.08]">
                              <SelectItem value="Full-Time Job Seeker">Full-Time Job Seeker</SelectItem>
                              <SelectItem value="Contractor / Freelancer">Contractor / Freelancer</SelectItem>
                      ...
                      <div className="space-y-2">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Primary Job Role</Label>
                        <div className="relative group">
                      ...
                      <div className="space-y-3">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Primary Skills (Press Enter to add)</Label>
                        <div className="relative group">
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      <div className="grid md:grid-cols-2 gap-5">
                        <div className="space-y-2">
                          <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Exp. Salary (Min $)</Label>
                          <div className="relative group">
                        ...
                        <div className="space-y-2">
                          <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Exp. Salary (Max $)</Label>
                          <div className="relative group">
                            <DollarSign className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-primary transition-all duration-300" />
                            <Input
                      ...
                      <div className="space-y-2">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Availability to Join</Label>
                        <Select 
                          value={formData.availableToJoin} 
                          onValueChange={(val) => setFormData({...formData, availableToJoin: val})}
                        >
                      ...
                      <div className="space-y-4">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Preferred Work Type</Label>
                        <div className="flex flex-wrap gap-4 mt-2">
                          {['remote', 'hybrid', 'on-site'].map((type) => (
                            <div key={type} className="flex items-center space-x-2">
                              ...
                              />
                              <label htmlFor={`type-${type}`} className="text-sm font-medium leading-none capitalize text-slate-600 dark:text-slate-400 cursor-pointer">
                                {type}
                              </label>
                            </div>
                          ))}
                      ...
                      <div className="space-y-4 pt-6 mt-6 border-t border-slate-100 dark:border-white/[0.05]">
                        <div className="flex items-start space-x-3 group">
                          ...
                          />
                          <label htmlFor="terms" className="text-xs font-medium leading-relaxed text-slate-500 dark:text-slate-400 cursor-pointer group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors">
                            I accept the <Link to="/terms" className="text-primary font-bold hover:underline">Terms of Service</Link> and agree to communications.
                          </label>
                        </div>
                        ...
                        <div className="flex items-start space-x-3 group">
                          <Checkbox 
                            ...
                            className="mt-1 border-slate-300 dark:border-white/10"
                          />
                          <label htmlFor="privacy" className="text-xs font-medium leading-relaxed text-slate-500 dark:text-slate-400 cursor-pointer group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors">
                            I agree to the <Link to="/privacy" className="text-primary font-bold hover:underline">Privacy Policy</Link> and data processing.
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      {isLoading ? (
                        ...
                        <div className="flex items-center gap-2">
                          <span>{currentStep === totalSteps ? 'Launch Your Career' : 'Next Step'}</span>
                ...
                <div className="mt-10 text-center">
                  <p className="text-[14px] text-slate-500 dark:text-slate-400 font-semibold tracking-tight">
                    ...
                    <Link to="/candidate-login" className="text-primary hover:opacity-80 transition-colors underline-offset-8 underline decoration-primary/30">
