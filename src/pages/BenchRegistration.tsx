...
const BenchRegistration = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="absolute z-10 top-8 left-16 animate-fade-up">
          ...
          <div className="space-y-8 max-w-lg" style={{ marginTop: "5rem" }}>
            ...
            <h1 className="text-[44px] font-bold text-white leading-[1.1] tracking-tight">
              Turn bench strength into
              <br />
              <span className="text-[#4DD9E8]">billable momentum.</span>
            </h1>

            <p className="text-[16px] text-white/50 leading-relaxed max-w-sm">
              List available resources, showcase verified skills, and connect
              your bench with teams ready to deploy talent.
            </p>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/80 text-[15px] font-medium">
                  Match skills to active requirements
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-5 h-5 rounded-md bg-[#4DD9E8]/10 border border-[#4DD9E8]/20">
      ...
      {/* Right Panel */}
      <div className={styles["bench-right-panel"]}>
        <div className={`${styles["bench-form-shell"]} animate-fade-up`}>
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <div className={styles["bench-otp-row"]}>
                            ...
                            <button
                              ...
                              className={styles["bench-otp-btn"]}
                            >
                              {isVerifyingOtp ? (
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] font-bold text-[#4DD9E8]/60 uppercase">
                              {(companyDocument.size / 1024 / 1024).toFixed(2)}{" "}
                              MB
                            </p>
                          </div>
                        </div>
