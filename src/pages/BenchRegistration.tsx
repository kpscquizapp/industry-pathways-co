            ...
            <div className={styles['bench-right-panel']}>
                <div className={`${styles['bench-form-shell']} animate-fade-up`}>
                    ...
                    <div className="lg:hidden mb-8 flex flex-col items-center">
                        ...
                        <p className="text-xs text-gray-400 uppercase tracking-widest">BENCH REGISTRATION</p>
                    </div>
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex flex-col gap-1.5">
                                                    ...
                                                    <div className={styles['bench-otp-row']}>
                                                        <div
                                                            className={`${styles['bench-otp-input']} flex items-center gap-2.5 bg-white border-[1.5px] rounded-[10px] px-3.5 h-[46px] transition-all duration-200 ${fieldErrors.otp
