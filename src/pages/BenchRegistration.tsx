...
const BenchRegistration = () => {
  ...
  return (
    <div className="h-vh bg-background flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-8 max-w-lg">
            ...
            <h1 className="text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] tracking-tight">
              Scale Your <br />
              <span className="bg-gradient-to-r from-primary via-emerald-400 to-green-400 bg-clip-text text-transparent">Partner Business</span>
            </h1>
            
            <p className="text-xl text-white/50 leading-relaxed font-light">
              Join the ecosystem where staffing leaders automate resource monetization and drive recurring revenue.
            </p>
          </div>
        </div>
              ...
              <div className="relative bg-white dark:bg-[#0a0a0a] rounded-[32px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] border border-slate-100 dark:border-white/[0.05] p-8 md:p-10">
                ...
                <div className="mb-6">
                  <h3 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-2">
                    {currentStep === 1 ? 'Partner Account' : currentStep === 2 ? 'Agency Details' : 'Verification'}
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {currentStep === 1 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      ...
                      <div className="grid md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-2">
                          <Label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Confirm</Label>
                          <div className="relative group">
                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-primary transition-all duration-300" />
                            <Input
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      <div className="space-y-2">
                        <Label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Agency Name</Label>
                        <div className="relative group">
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Agency Details</Label>
                        <Textarea
                          name="companyDetails"
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      <div className="space-y-2">
                        <Label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Company Document (ID/Verification)</Label>
                        {!companyDocument ? (
                          <div 
                      ...
                      <div className="text-[11px] text-slate-400 leading-relaxed bg-slate-50 dark:bg-white/5 p-4 rounded-xl border border-slate-100 dark:border-white/10">
                        By submitting this application, you agree to Hirion's staffing partner terms and permit us to verify your agency credentials.
                      </div>
                    </div>
                  )}
                    ...
                    >
                      {isLoading ? (
                        ...
                        <div className="flex items-center gap-2">
                          <span>{currentStep === totalSteps ? 'Submit Application' : 'Next Step'}</span>
                ...
                <div className="mt-10 pt-8 border-t border-slate-100 dark:border-white/[0.03] flex flex-col items-center gap-4">
                  <p className="text-[14px] text-slate-500 dark:text-slate-400 font-semibold tracking-tight">
                    Already a partner?{' '}
                    <Link to="/bench-login" className="text-primary hover:text-primary/80 transition-colors underline-offset-8 underline decoration-primary/30">
                      Sign In
                    </Link>
                  </p>
                </div>
