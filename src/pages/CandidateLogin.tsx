...
import { User, Sparkles, ArrowRight, Mail, Lock, Briefcase, Star, Clock, ShieldCheck, Rocket, LayoutDashboard } from 'lucide-react';
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-8 max-w-lg">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full">
              ...
              <span className="text-white/80 text-[10px] font-bold tracking-[0.1em] uppercase">Candidate Portal</span>
            </div>
            
            <h1 className="text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] tracking-tight">
              Welcome Back,<br />
              <span className="bg-gradient-to-r from-primary via-emerald-400 to-green-400 bg-clip-text text-transparent">Contractor</span>
            </h1>
            
            <p className="text-xl text-white/50 leading-relaxed font-light">
              Log in to access your dream contracts and manage your professional profile.
            </p>
          </div>
        </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-[#0a0a0a] rounded-[32px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] border border-slate-100 dark:border-white/[0.05] p-8 md:p-10">
                <div className="mb-10 text-center lg:text-left">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap">Enter your candidate credentials below.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link to="/forgot-password" title="Forgot Password" className="text-xs font-bold text-primary dark:text-emerald-400 hover:opacity-80 transition-opacity">
                        Forgot password?
                      </Link>
                    </div>
                    <div className="relative group">
                ...
                <div className="mt-10 pt-8 border-t border-slate-100 dark:border-white/[0.03] flex flex-col items-center gap-4">
                  <p className="text-[14px] text-slate-500 dark:text-slate-400 font-semibold tracking-tight">
                    New to Hirion?{' '}
                    <Link to="/candidate-signup" className="text-primary hover:text-emerald-500 transition-colors underline-offset-8 underline decoration-primary/30">
