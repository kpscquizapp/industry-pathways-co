  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 sm:px-8 py-6 sm:py-8 font-inter">
      <div className="max-w-[1440px] mx-auto space-y-7">
        ...
        {/* Tab Filter */}
        <div className="flex">
          <div className="inline-flex bg-gray-100 rounded-[14px] p-1.5">
            <button
              onClick={() => {
                setActiveTab("active");
                setCurrentPage(1);
        ...
        {isLoading || isFetching ? (
          ...
          <Card className="border border-[hsl(40 15% 88%)] rounded-2xl shadow-[var(--shadow-card)] bg-white">
                        ...
                        <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-[13px] font-medium text-gray-500">
                          {job.location && (
                            <span className="flex items-center gap-1.5">
                              ...
                              {job.location}
                              {job.workMode &&
                                ` / ${(job.workMode as string).charAt(0).toUpperCase() + (job.workMode as string).slice(1)}`}
                            </span>
                          )}
                          {job.employmentType && (
                            <span className="flex items-center gap-1.5">
