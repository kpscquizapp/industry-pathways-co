...
const EmployerSettings = () => {
  ...
  const {
    ...
    refetch: refetchEmployerProfileImage,
  } = useGetEmployerProfileImageQuery(token && user?.id ? user.id : skipToken);
  ...
  useEffect(() => {
    if (employerData || user) {
      setFormData({
        ...
        companyName:
          employerData?.companyName || user?.companyName || user?.company || "",
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      try {
        ...
        // refetch employer profile image so UI updates where used
        try {
  ...
  return (
    <div className="min-h-full bg-gray-50 font-inter pb-12">
      <div className="px-6 sm:px-10 md:px-8 py-6 md:py-10 max-w-[1400px] mx-auto space-y-8">
        {/* ═══════════════ HEADER ═══════════════ */}
        <div>
              ...
              <>
                ...
                <Card className="border-none shadow-sm rounded-xl overflow-hidden bg-white">
                  <div className="px-6 py-5 border-b border-gray-50">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Update your personal profile details and email address.
                    </p>
                  </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex gap-3">
                          ...
                          >
                            {isUploadingImage ? (
                              <SpinnerLoader className="mr-2 h-3 w-3" />
                            ) : (
                          ...
                          {profileImage && (
                            <Button
                              variant="ghost"
                              className="h-9 px-4 text-xs font-bold text-red-500 hover:text-red-600 hover:bg-red-50 bg-red-50"
                ...
                <Card className="border-none shadow-sm rounded-xl overflow-hidden bg-white">
                  <div className="px-6 py-5 border-b border-gray-50">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      These details will be visible to candidates during the
                      interview process.
                    </p>
                  </div>
                  <CardContent className="p-8 space-y-8">
            ...
            {activeNav === "Account Settings" && (
              <>
                ...
                <Card
                  ...
                  className="p-5 sm:p-6 md:p-8 flex flex-col gap-6 shadow-sm border border-gray-100 rounded-2xl bg-white"
                >
                    ...
                    <div className="flex flex-col gap-2 w-full">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full h-12 pr-10 px-4 rounded-xl bg-slate-50 border-2 border-slate-100 outline-none transition-all duration-200 focus:border-[#4DD9E8] focus:bg-white text-slate-900 text-sm font-medium placeholder:text-slate-400"
                        />
                        <button
                          type="button"
                          onClick={() =>
                ...
                <Card className="p-5 sm:p-6 md:p-8 border-red-100 bg-red-50/90 shadow-red-100/20 rounded-2xl">
                  ...
                  <div className="flex flex-col gap-4">
                    <p className="text-sm text-slate-600 max-w-2xl leading-relaxed">
                      ...
                      your profile data, interview history, and skill assessment
                      ...
                      <AlertDialogContent className="sm:max-w-[425px]">
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription className="text-slate-600 py-4">
                            ...
                            and cannot be undone. All your professional data
                            will be wiped from our systems.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
