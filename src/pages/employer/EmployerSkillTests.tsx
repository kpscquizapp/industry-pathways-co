...
const EmployerSkillTests = () => {
  ...
  const [activeView, setActiveView] = useState<'shortlisted' | 'invited' | 'completed'>('shortlisted');
    ...
    <div className="min-h-screen bg-[#f2f5fa] px-4 sm:px-8 py-6 sm:py-8 font-sans">
      <div className="max-w-[1440px] mx-auto space-y-7">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
           ...
           >
              <div>
                 <p className="text-[12px] font-bold text-gray-400 uppercase tracking-wider">Shortlisted</p>
                ...
                <CardContent className="p-0">
                  {invitedCandidates.length > 0 ? (
                    ...
                    <div className="text-center py-20 text-gray-400 bg-gray-50/50">
                      ...
                      <p className="font-bold text-gray-700 text-[15px]">No invited candidates</p>
                      <p className="text-[13px] mt-1.5 max-w-[280px] mx-auto text-center leading-relaxed">Schedule a test for a shortlisted candidate to see them here.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <CardContent className="p-0">
                {completedCandidates.length > 0 ? (
                  ...
                  <div className="text-center py-20 text-gray-400 bg-gray-50/50">
                    ...
                    <p className="font-bold text-gray-700 text-[15px]">No completed tasks</p>
                    <p className="text-[13px] mt-1.5 max-w-[280px] mx-auto text-center leading-relaxed">Once candidates finish their tests, their results will appear here.</p>
                  </div>
                )}
              </CardContent>
            </Card>
