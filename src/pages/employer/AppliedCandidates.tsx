...
const AppliedCandidates = () => {
  ...
  const [candidateForAction, setCandidateForAction] = useState<
    (typeof mockCandidates)[0] | null
  >(null);
  ...
  const stats = [
    ...
    {
      label: "High Match (>80%)",
      value: mockCandidates.filter((c) => c.matchScore >= 80).length,
      icon: Star,
      color: "text-yellow-600",
    },
    {
      label: "Test Passed",
      value: mockCandidates.filter((c) => c.skillTestStatus === "Passed")
        .length,
      icon: ClipboardCheck,
    ...
    },
    {
      ...
      value: mockCandidates.filter((c) => c.aiInterviewStatus === "Completed")
        .length,
      icon: Brain,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Applied Candidates • Job ID: {jobId}
          </p>
        </div>
      </div>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Select
              ...
              onValueChange={setSkillMatchFilter}
            >
          ...
          <Table>
            ...
            <TableBody>
              {filteredCandidates.map((candidate) => {
                const testStatus = getTestStatusBadge(
                  candidate.skillTestStatus,
                );
                const interviewStatus = getTestStatusBadge(
                ...
                return (
                  <TableRow key={candidate.id} className="hover:bg-muted/30">
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={cn("gap-1", testStatus.class)}
                      >
                        {testStatus.icon}
                        {candidate.skillTestStatus}
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={cn("gap-1", interviewStatus.class)}
                      >
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu modal={false}>
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                          ...
                          <DropdownMenuSeparator />
                          <DropdownMenuItem
                            onClick={() => handleSendTestInvite(candidate)}
                          >
                            <Play className="h-4 w-4 mr-2" />
                            Send Skill Test
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() => handleSendInterviewInvite(candidate)}
                          >
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              handleMoveToHumanInterview(candidate)
                            }
                          >
              ...
              <div className="space-y-6 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Card className="p-4">
                    ...
                    <Progress
                      value={selectedCandidate.skillsMatch}
                      className="mt-2"
                    />
                  </Card>
                </div>
                  ...
                  <div>
                    ...
                    <Card className="p-4">
                      ...
                      <Badge
                        className={cn(
                          "mt-2",
                          getTestStatusBadge(selectedCandidate.skillTestStatus)
                            .class,
                        )}
                      >
                ...
                <div className="flex flex-col gap-2 pt-4 border-t">
                  ...
                  <Button
                    variant="outline"
                    onClick={() =>
                      handleMoveToHumanInterview(selectedCandidate)
                    }
                  >
                    <UserPlus className="h-4 w-4 mr-2" />
                    Move to Human Interview
      ...
      <Dialog open={showInterviewModal} onOpenChange={setShowInterviewModal}>
        <DialogContent className="max-w-md">
          ...
          <div className="py-4 space-y-4">
            <p className="text-muted-foreground text-sm">
              Assign an AI interview to{" "}
              <strong>{candidateForAction?.name}</strong>
            </p>
