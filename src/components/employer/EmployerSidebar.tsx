...
const menuItems = [
  ...
  },
  {
    ...
    icon: UserPlus,
    path: "/employer-dashboard/post-bench-resource",
    isAI: false,
  },
  {
    title: "Active Resources",
    icon: Users,
    path: "/employer-dashboard/active-resources",
    isAI: false,
  },
  {
    title: "Visibility Settings",
    icon: Eye,
    path: "/employer-dashboard/visibility-settings",
    isAI: false,
  },
];
            ...
            const isActive =
              ...
              (item.path === "/employer-dashboard" &&
                (currentPath === "/employer-dashboard" ||
                  currentPath === "/employer-dashboard/dashboard"));
