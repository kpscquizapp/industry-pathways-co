...
const UserTypesSection = () => {
  ...
  const userTypes = {
    contractor: {
      ...
      icon: User,
      description:
        "Get matched to jobs automatically and accelerate your career",
      ...
      link: `${user?.role === "candidate" ? "/contractor/dashboard" : "/contractor-signup"}`,
    },
    bench: {
    ...
    hiring: {
      ...
      cta: "Start Hiring",
      link: `${user?.role === "employer" ? "/hire-talent/dashboard" : "/hire-talent-signup"}`,
    },
  };
      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Whether you're a contractor, a company with bench resources, or
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${type.color} flex items-center justify-center`}
                    >
                ...
                <div className="relative">
                  <div className="bg-card rounded-2xl border border-border p-8 shadow-premium">
                    <div className="aspect-video bg-gradient-to-br from-muted to-muted/50 rounded-xl flex items-center justify-center">
                      <div
                        className={`w-24 h-24 rounded-2xl bg-gradient-to-br ${type.color} flex items-center justify-center animate-float`}
                      >
