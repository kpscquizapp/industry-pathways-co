        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <p className="text-xl text-white/70 max-w-lg">
              AI-matched resumes, skill tests, and automated interviews — all in
              one platform.
            </p>
          ...
          <div className="relative hidden lg:block">
            <div className="relative">
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-primary font-bold text-sm min-w-[40px] text-right">
                          {candidate.match}%
                        </span>
                      </div>
                    </div>
              ...
              <div className="absolute -right-4 top-1/2 bg-navy-800/90 backdrop-blur-xl border border-green-400/30 rounded-xl px-4 py-2.5 shadow-xl animate-float">
                <div className="flex items-center gap-2">
