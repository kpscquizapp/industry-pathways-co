...
const features = [
  {
    ...
    description:
      "Find skilled professionals for short-term projects and specialized tasks",
  },
  {
    title: "Bench Resources",
    description:
      "Access pre-vetted talent from IT services companies available immediately",
  },
  {
    title: "AI Interview Scheduling",
    description:
      "Automate screening with AI interviews and make faster hiring decisions",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="fade-in-section">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg">
              Access contract professionals, freelancers, and bench resources
              from top companies. Hire faster with AI-powered matching.
            </p>
