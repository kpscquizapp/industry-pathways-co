...
const RegistrationStepIndicator: React.FC<RegistrationStepIndicatorProps> = ({
  ...
  return (
    <div className="mb-10 w-full px-1">
      <div className="flex items-center justify-center sm:justify-start mb-8 gap-x-2 sm:gap-x-4">
        {steps.map((step, idx) => (
          <div key={idx} className="flex items-center">
            <div className="flex items-center gap-2">
              ...
              <span
                className={cn(
                  "text-[10px] sm:text-[11px] font-bold tracking-widest transition-colors duration-300 text-[#080b20] hidden sm:inline",
                  currentStep === idx + 1
